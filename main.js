...
if(page=="page6"){window.location='#12345#';}}
...
showProgress();}
else{document.getElementById("steps_progress").src="https://i.imgur.com/sfIZduh.png";nextPage("page4");hideProgress();for(var i=0;i<4;i++){document.getElementById("btn"+i).style.display="none";}}
...
function showProgress(){var currQuestNum=quiz.questionIndex+1;if(currQuestNum==2){document.getElementById("steps_progress").src="https://i.imgur.com/0eOjt2v.png";}
else if(currQuestNum==3){document.getElementById("steps_progress").src="https://i.imgur.com/CRUdq1y.png";}}
